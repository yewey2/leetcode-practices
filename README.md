...
├── problems/
│   ├── 0001-problem-name/
│   │   ├── solution.py (or solution.js, solution.cpp, etc.)
...
Use this template for new problem folders so the format stays consistent:
...
- Solved: <finish time/date>

Approach: <short summary of the solution idea and complexity>.
